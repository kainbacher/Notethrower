...
showFormField('Artist/Band name',           'text',     'name',             '', '<div class="toolTipWrapper"><div class="toolTip"><img src="../Images/icons/icon_info.png" alt="icon_info" width="16" height="16" /></div><div class="toolTipContent">Please put your band or artist name in the field.</div></div>', true,  255, $artist, $unpersistedArtist, $problemOccured, $errorFields);
...
if ($userIsLoggedIn) { // it's an update
    ...
    showFormField('Password',               'password', 'old_password',     '', '<div class="toolTipWrapper"><div class="toolTip"><img src="../Images/icons/icon_info.png" alt="icon_info" width="16" height="16" /></div><div class="toolTipContent">If you want to change your password, enter you old password here.</div></div>', false,  255, $artist, $unpersistedArtist, $problemOccured, $errorFields);
    showFormField('New Password',           'password', 'password',         '', '<div class="toolTipWrapper"><div class="toolTip"><img src="../Images/icons/icon_info.png" alt="icon_info" width="16" height="16" /></div><div class="toolTipContent">Enter your new password here if you want to change it.</div></div>', false, 255, $artist, $unpersistedArtist, $problemOccured, $errorFields);
...
showFormField('Artist/Band information',    'textarea', 'artist_info',      '', '<div class="toolTipWrapper"><div class="toolTip"><img src="../Images/icons/icon_info.png" alt="icon_info" width="16" height="16" /></div><div class="toolTipContent">Tell us a bit about yourself or your band. What other bands or music influenced you? Where are you from?</div></div>', false, 0,   $artist, $unpersistedArtist, $problemOccured, $errorFields);
showFormField('Additional information',     'textarea', 'additional_info',  '', '<div class="toolTipWrapper"><div class="toolTip"><img src="../Images/icons/icon_info.png" alt="icon_info" width="16" height="16" /></div><div class="toolTipContent">Anything else we should know?</div></div>', false, 0,   $artist, $unpersistedArtist, $problemOccured, $errorFields);
