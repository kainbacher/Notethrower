...
if ($project->visibility == 'private' && !projectIdIsAssociatedWithUserId($projectId, $originatorUserId)) {
    show_fatal_error_and_exit('user with id ' . $originatorUserId . ' is not allowed to upload a file to project with id: ' . $projectId);
}
